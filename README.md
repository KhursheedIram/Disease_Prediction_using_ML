...
### 1. Decision Tree
![decisiontree](https://github.com/KhursheedIram/Disease_Prediction_using_ML/blob/main/imgs/decision.gif)
#### Introduction
...
### 2. Random Forest
![RandomForest](https://github.com/KhursheedIram/Disease_Prediction_using_ML/blob/main/imgs/random.jpeg)
#### Introduction
...
####
![randomforest](https://github.com/KhursheedIram/Disease_Prediction_using_ML/blob/main/imgs/random2.jpeg)
####
...
### 3. Naive Bayes
![Naive Bayes](https://github.com/KhursheedIram/Disease_Prediction_using_ML/blob/main/imgs/naive.jpeg)
#### Principle of Naive Bayes Classifier
A Naive Bayes classifier is a probabilistic machine learning model that’s used for classification task. The crux of the classifier is based on the Bayes theorem.
#### Bayes Theorem
![formula](https://github.com/KhursheedIram/Disease_Prediction_using_ML/blob/main/imgs/bayes.png)
####
